...
bool HTMLInputElement::isDateControl() const
{
    return formControlType() == InputTypeNames::date();
}

bool HTMLInputElement::isTimeControl() const
{
    return formControlType() == InputTypeNames::time();
}

bool HTMLInputElement::isDateTimeControl() const
{
    return formControlType() == InputTypeNames::datetime();
}

bool HTMLInputElement::isDateTimeLocalControl() const
{
    return formControlType() == InputTypeNames::datetimelocal();
}

bool HTMLInputElement::isMonthControl() const
{
    return formControlType() == InputTypeNames::month();
}

bool HTMLInputElement::isResetButton() const
{
    return formControlType() == InputTypeNames::reset();
}

...
public:
    ...
    // const KeyframeValueList& values() const { return m_values; }

    // NOTE: Don't expose the animation directly either, the client could do
    // non-threadsafe refcounting on the Animation or its TimingFunctions,
    // which would be bad.

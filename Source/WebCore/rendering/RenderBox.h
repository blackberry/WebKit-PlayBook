...
public:
    ...
    int rightAbsoluteLayoutOverflow() const { return m_absoluteOverflow ? m_absoluteOverflow->maxXLayoutOverflow() : maxXVisualOverflow(); }
    int bottomAbsoluteLayoutOverflow() const { return m_absoluteOverflow ? m_absoluteOverflow->maxYLayoutOverflow() : maxYVisualOverflow(); }
    int rightAbsoluteVisibleOverflow() const { return m_absoluteOverflow ? m_absoluteOverflow->visualOverflowRect().maxX() : maxXVisualOverflow(); }
    int bottomAbsoluteVisibleOverflow() const { return m_absoluteOverflow ? m_absoluteOverflow->visualOverflowRect().maxY() : maxYVisualOverflow(); }
...
private:
    ...
    void notifyLayerOfGeometryChange();

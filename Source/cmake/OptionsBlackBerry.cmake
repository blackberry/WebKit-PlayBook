...
IF (ENABLE_GLES2)
    ...
    WEBKIT_FEATURE(ENABLE_ACCELERATED_2D_CANVAS "Enable Accelerated 2D Canvas " DEFAULT ON)
ELSE ()
    WEBKIT_FEATURE(ENABLE_3D_RENDERING "Enable 3D Rendering" DEFAULT OFF)
    WEBKIT_FEATURE(ENABLE_WEBGL "Enable WebGL" DEFAULT OFF)
    WEBKIT_FEATURE(ENABLE_ACCELERATED_2D_CANVAS "Enable Accelerated 2D Canvas " DEFAULT OFF)
ENDIF ()

WEBKIT_FEATURE(ENABLE_WEBDOM "Enable C++ DOM bindings" DEFAULT OFF)
IF (ENABLE_WEBDOM)
...
WEBKIT_FEATURE(ENABLE_FULLSCREEN_API "Enable Fullscreen API" DEFAULT ON)
...
WEBKIT_FEATURE(ENABLE_INPUT_TYPE_DATE "Enable Color Input" DEFAULT ON)
WEBKIT_FEATURE(ENABLE_INPUT_TYPE_DATETIME "Enable Color Input" DEFAULT ON)
WEBKIT_FEATURE(ENABLE_INPUT_TYPE_DATETIMELOCAL "Enable Color Input" DEFAULT ON)
WEBKIT_FEATURE(ENABLE_INPUT_TYPE_MONTH "Enable Color Input" DEFAULT ON)
WEBKIT_FEATURE(ENABLE_INPUT_TYPE_TIME "Enable Color Input" DEFAULT ON)
WEBKIT_FEATURE(ENABLE_INPUT_TYPE_WEEK "Enable Color Input" DEFAULT ON)
...
WEBKIT_FEATURE(ENABLE_OVERFLOW_SCROLLING "Enable overflow scrolling" DEFAULT ON)
...
WEBKIT_FEATURE(ENABLE_SQL_DATABASE "Enable database" DEFAULT ON)
...
ELSE ()
  ...
  WEBKIT_FEATURE(ENABLE_DFG_JIT "Enable DFG JIT" DEFAULT ON)
ENDIF ()

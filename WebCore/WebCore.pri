...
!contains(DEFINES, ENABLE_EVENT_MODE_METATAGS=.): DEFINES += ENABLE_EVENT_MODE_METATAGS=1
...
contains(DEFINES, ENABLE_INSPECTOR=1) {
    INSPECTOR_INTERFACES = inspector/Inspector.idl
    INSPECTOR_BACKEND_STUB_QRC = inspector/front-end/InspectorBackendStub.qrc
    INSPECTOR_FRONTEND_HTML = $$system(ls $$PWD/inspector/front-end/*.html)
    INSPECTOR_FRONTEND_CSS = $$system(ls $$PWD/inspector/front-end/*.css)
    INSPECTOR_FRONTEND_JS = $$system(ls $$PWD/inspector/front-end/*.js)
    INSPECTOR_FRONTEND_IMAGES = $$system(ls $$PWD/inspector/front-end/Images/*.gif $$PWD/inspector/front-end/Images/*.png)
...
inspectorIDL.commands = perl -I$$PWD/bindings/scripts -I$$PWD/inspector $$inspectorIDL.wkScript --defines \"$${FEATURE_DEFINES_JAVASCRIPT_BINDINGS}\" --generator Inspector --outputDir $$WC_GENERATED_SOURCES_DIR --preprocessor \"$${QMAKE_MOC} -E\" ${QMAKE_FILE_NAME}
...
inspectorFrontEndResources.wkAddOutputToSources = false
inspectorFrontEndResources.output = $${WC_GENERATED_SOURCES_DIR}/InspectorFrontEndResources.cpp
INSPECTORFRONTENDRESOURCES_SCRIPT = $$PWD/../WebKitTools/Scripts/generate-inspector-frontend-resources.pl
inspectorFrontEndResources.input = inspectorIDL INSPECTORFRONTENDRESOURCES_SCRIPT
inspectorFrontEndResources.depend = $${WC_GENERATED_SOURCES_DIR}/InspectorBackendStub.js INSPECTORFRONTENDRESOURCES_SCRIPT
inspectorFrontEndResources.commands = perl $$INSPECTORFRONTENDRESOURCES_SCRIPT $${WC_GENERATED_SOURCES_DIR} $${WC_GENERATED_SOURCES_DIR}/InspectorBackendStub.js $$INSPECTOR_FRONTEND_HTML $$INSPECTOR_FRONTEND_CSS $$INSPECTOR_FRONTEND_JS $$INSPECTOR_FRONTEND_IMAGES
addExtraCompiler(inspectorFrontEndResources)

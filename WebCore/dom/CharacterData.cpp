...
void CharacterData::insertData(unsigned offset, const String& data, ExceptionCode& ec, SecureMode secureMode)
{
    checkCharDataOperation(offset, ec);
    if (ec)
        return;
    ...
    if (atEnd && (secureMode == MomentarilyRevealLastCharacter) && renderer()) {

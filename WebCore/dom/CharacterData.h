...
public:
    enum SecureMode { AlwaysHideCharacters, MomentarilyRevealLastCharacter };
    ...
    void insertData(unsigned offset, const String&, ExceptionCode&, SecureMode = AlwaysHideCharacters);

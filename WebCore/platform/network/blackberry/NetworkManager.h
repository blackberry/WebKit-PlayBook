...
namespace Olympia {
    ...
    namespace WebKit {
        ...
        public:
            ...
            void pauseLoad(WTF::PassRefPtr<WebCore::ResourceHandle> job, bool pause);

            Platform::FilterStream* streamForHandle(WTF::PassRefPtr<WebCore::ResourceHandle>);
        ...
        private:
            ...
            bool startJob(int playerId, const WTF::String& pageGroupName, WTF::PassRefPtr<WebCore::ResourceHandle> job, const WebCore::ResourceRequest& request, Platform::NetworkStreamFactory* streamFactory, const WebCore::Frame& frame, int deferLoadingCount = 0, int redirectCount = 0);

...
class MKSBug(object):
    ...
    _map_rim_to_mks_handhelds = {"Atlas" : "Atlas",
                                 ...
                                 "Storm R027" : "R027",
                                 "Talladega" : "Talladega",
                                 "Jennings R040" : "Jennings R040"
                                }
    _default_mks_handheld = "Talladega"

    # Maps rim_bug.os() to MKS component targeted release
    # FIXME: We map Bugzilla OS 6.1 to MKS 6.0.0 since MKS Integrity disallows Component Targeted Releases 6.1.0
    # when Dev Task Component is Browser. See RIM Bug #1811.
    _map_rim_to_mks_release = {"5.2" : "5.2.0", "6.0" : "6.0.0", "6MR1" : "6.0.0", "6.1" : "6.0.0"}

...
MACRO(GENERATE_JS_FROM_IDL _source)
  ...
  ADD_CUSTOM_COMMAND(
    ...
    COMMAND ${PERL_EXECUTABLE} -I${WEBCORE_DIR}/bindings/scripts ${BINDING_CODE_GENERATOR} ${PREPROCESSOR} ${IDL_INCLUDES} --outputDir "${DERIVED_SOURCES_DIR}" --defines "LANGUAGE_JAVASCRIPT=1 ${FEATURE_DEFINES_STR}" --generator JS ${WEBCORE_DIR}/${_source})
...
MACRO(GENERATE_INSPECTOR_FROM_IDL _source)
  ...
  ADD_CUSTOM_COMMAND(
    ...
    DEPENDS ${BINDING_CODE_GENERATOR} ${SCRIPTS_BINDINGS} ${WEBCORE_DIR}/${_source}
    COMMAND ${PERL_EXECUTABLE} -I${WEBCORE_DIR}/bindings/scripts -I${WEBCORE_DIR}/inspector ${BINDING_CODE_GENERATOR} ${PREPROCESSOR} ${IDL_INCLUDES} --outputDir "${DERIVED_SOURCES_DIR}" --defines "LANGUAGE_JAVASCRIPT=1 ${FEATURE_DEFINES_STR}" --generator Inspector ${WEBCORE_DIR}/${_source})
...
MACRO(GENERATE_DOM_NAMES_FACTORY _namespace _tags _attrs)
  ...
  ENDFOREACH ()
  IF (_extradef)
    STRING(STRIP "${_extradef}" _extradef)
...
#
# The generated files (WebDOM*.cpp, WebDOM*.h) lives in ${DERIVED_SOURCES_DIR}.
#
...
MACRO(GENERATE_WEBDOM_FROM_IDL _source)
  ...
  LIST(APPEND WEBDOM_IDL_HEADERS ${DERIVED_SOURCES_DIR}/WebDOM${_name}.h)
  UNSET(_name)
  UNSET(_defines)
ENDMACRO()
